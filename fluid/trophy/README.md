...
3. Рассчитайте и запишите нижний внешний отступ блоков с классом `.trophy` так, чтобы он зависел от ширины блока `.trophies` и при ширине окна браузера `1280px` составлял бы `30px`.
