...
2. Укажите значения минимальной и максимальной ширины блока `.container`. Ширина этого блока должна достигать своего наименьшего значения `768px` при ширине окна браузера, равной `768px`, и наибольшего значения `1300px` &mdash; при ширине окна `1366px`.
Внутренние отступы должны оставаться неизменными. Внутренние отступы блока должны оставаться неизменными.
