...
2. Укажите значения минимальной и максимальной ширины блока `.container`. Ширина этого блока должна достигать своего наименьшего значения `748px` при ширине окна браузера, равной `768px`, и наибольшего значения `1280px` при ширине окна `1300px`.
Внутренние отступы должны оставаться неизменными.
