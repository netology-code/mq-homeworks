...
2. Укажите значения минимальной и максимальной ширины блока `.container`. Ширина этого блока должна достигать своего наименьшего значения при ширине окна браузера, равной `768px`, и наибольшего значения при ширине окна `1300px`.
