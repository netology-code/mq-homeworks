...
Первым элементом, в который нужно внести правки, будет шапка сайта. Нужно избавиться от горизонтальной полосы прокрутки на экране с разрешением 1024x768px.
При этом на мониторах ширины большей, чем ширина контента (например, 1920x1080px) сайт должен располагаться по центру.
