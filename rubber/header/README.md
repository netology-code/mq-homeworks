...
Первым элементом, с которого вы начнете это шапка сайта. Сделайте так, чтобы на экране с разрешение 1024x768px
содержимое отображалось без горизонтальной полосы прокрутки. А на мониторе 1920x1080px блок находился по центру.

## Процесс реализации

1. Измените свойство width для блока с классом `container` так, чтобы элемент занимался всю доступную ширину родительского элемента с классом header.
