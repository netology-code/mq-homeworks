...
![Header on a widescreen](../../sources/rubber-header-widescreen.jpg)
...
Правильность своего решения можно проверить, меняя ширину окна браузера и следя за изменениями размеров блоков. Когда вы дойдете до значения `1024px`, то фон примера должен измениться следующем образом:

![Header on a small screen](../../sources/rubber-header-smallscreen.jpg)
