...
1. Для устройств с шириной экрана от `769px` расположите карточки товара в ряд, используя flexbox. Ширина каждой карточки должна быть `32%`. Карточки не должны тянуться по высоте. 

2. Для устройств с шириной экрана от `769px` у второй, пятой и восьмой карточек задайте недостающие отступы слева и справа.
